...
################################################################################
## Form generated from reading UI file 'Normal_result1.ui'
##
...
"}")
    ...
    def retranslateUi(self, Right_Breast):
        ...
        self.label.setText(QCoreApplication.translate("Right_Breast", u"Result :", None))
        self.DecisionVar.setText(QCoreApplication.translate("Right_Breast", u"Normal \u2698", None))
